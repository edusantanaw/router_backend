...
export class DisableCustomerUsecase implements IDisableUsecase<ICustomer> {
  ...
  public async disable(id: string) {
    ...
    if (!customerExists.active)
      throw new AlreadyDisabledException(messages.alreadyDisabled);
